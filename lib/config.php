 ...
 */
define( 'THEME_TEXTDOMAIN', 'feather' );	// Unique identifier for retrieving translated strings.
...
define( 'ARCHIVE_WIDGET_LIMIT', 18 );		// Limit Number of Months in WordPress Archives Widget
